...
use App\Models\Anagrafiche\TipologiaArticolo;
use Filament\Forms\Components\TextInput\Mask;
use Filament\Forms\Components\BelongsToSelect;
use App\Filament\Resources\PfcmadreResource\Pages;
use App\Filament\Resources\PfcmadreResource\RelationManagers;
use Mohamedsabil83\FilamentFormsTinyeditor\Components\TinyEditor;

class PfcmadreResource extends Resource
{
    protected static ?string $model = Pfcmadre::class;
    ...
    protected static ?string $slug = 'pfcmadre';

    protected static ?string $label = 'Pfcmadre';

    protected static ?string $pluralLabel = 'pfcmadre';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('cliente.nome')->limit(50),
                // Tables\Columns\BooleanColumn::make('condizionamento_stampo'),
                // Tables\Columns\BooleanColumn::make('utilizza_robot'),
                // Tables\Columns\BooleanColumn::make('stampaggio_automatico'),
                // Tables\Columns\BooleanColumn::make('condizionamento_necessario'),
                // Tables\Columns\BooleanColumn::make('piu_fasi_stampaggio'),
                // Tables\Columns\TextColumn::make('articolo.codice')->limit(50),
                // Tables\Columns\TextColumn::make('stampo.codice')->limit(50),
                //Tables\Columns\TextColumn::make('polimero.codice')->limit(50),
                //Tables\Columns\TextColumn::make('master.codice')->limit(50),
            ])
            ->filters([
                //
            ]);
    ...
    // {
    //     return [
    //         PfcmadreResource\RelationManagers\PresseRelationManager::class,
    //     ];
    // }

    public static function aggiornaPesi()
    {
        return 45;
    }
    ...
    {
        return [
            'index' => Pages\ListPfcmadre::route('/'),
            'create' => Pages\CreatePfcmadre::route('/create'),
            'edit' => Pages\EditPfcmadre::route('/{record}/edit'),
        ];
    }
}
